...
namespace ServerStateSimulation
{
    public class ParseState
    {
        ...
        {
            /// Just for Testing ....
            var PropertiesTestValues = new Dictionary<int, string>(); 
            ///
            ...
            /// test
            getDeviceTypes(PropertiesTestValues,house, xd);
            getServices(house, xd);
            /// test
            getDevices(PropertiesTestValues,house, xd);
        ...
        /// </summary>
        /// <returns></returns
        private void getDeviceTypes(Dictionary<int,string> PropertiesTestValues,House house, XDocument xd)
        {
            foreach (var devtype in xd.Root.Element("DeviceTypeList").Elements("DeviceType"))
            {
                ...
                foreach (var proptype in devtype.Element("PropertyTypeList").Elements("PropertyType"))
                {
                    ...
                    try
                    {
                        PropertiesTestValues.Add(prop.ID, proptype.Attribute("Value").Value);
                    }
        ...
        /// </summary>
        /// <returns></returns
        private void getDevices(Dictionary<int,string> PropertiesTestValues,House house, XDocument xd)
        {
            ...
            foreach (var item in xd.Root.Element("DeviceList").Elements("Device"))
            {
                ...
                foreach (var proptype in devtype.PropertyTypes)
                {
                    ...
                    {
                        Type = proptype,
                        Value = PropertiesTestValues[proptype.ID]
